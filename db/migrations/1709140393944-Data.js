module.exports = class Data1709140393944 {
    name = 'Data1709140393944'

    async up(db) {
        await db.query(`CREATE TABLE "circulation" ("id" character varying NOT NULL, "block_height" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "reward" numeric NOT NULL, "phala_chain_bridge" numeric NOT NULL, "khala_chain_bridge" numeric NOT NULL, "sygma_bridge" numeric NOT NULL, "total_supply" numeric NOT NULL, "circulation" numeric NOT NULL, CONSTRAINT "PK_6e548c45bfff22b5cd3db45c49e" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "snapshot" ("id" character varying NOT NULL, "block_height" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "reward" numeric NOT NULL, "phala_chain_bridge" numeric NOT NULL, "khala_chain_bridge" numeric NOT NULL, "sygma_bridge" numeric NOT NULL, "total_supply" numeric NOT NULL, "circulation" numeric NOT NULL, CONSTRAINT "PK_47b29c1a6055220b1ebdafdf7b5" PRIMARY KEY ("id"))`)
